    ...
    <div class="container" style="margin-top: 150px;">
        ...
        <div class="row mt-5 mb-5">
            ...
            <div class="col-sm-12 position-relative p-4">
                ...
                <h1 class="float-end" style="margin-right: 90px;"><b>Your Privacy<br> Make Other People Happy</b></h1>


                <div class="tombol mt-5 float-end" style="padding: 70px; margin-right: 100px;">
                    <a href="Ddiscussion_page.php" class="btn btn-outline-success  shadow tebel-sedang" style="border-radius: 50px;">Start The Journey</a>
                </div>
      ...
      <div class="discuss">
        ...
        <div style="
          ...
          <?php foreach($thread as $row) : ?>
                ...
                <p style="margin-left: 20px; margin-bottom: 50px; margin-right: 20px;  "><?= $row["content"]; ?></p>



            </div>
            <?php endforeach; ?>
            <a href="Ddiscussion_detail.php?idthread=<?= $row["idthread"]; ?>" 
                    ...
                    <a href="Ddiscussion_page.php" class="active btn btn-outline-primary bg-ungu shadow tebel-sedang" 
                    ...
                    <div class="container" style="margin-top: 50px;">
                        ...
                        <div class="row mt-5 mb-5">
                            ...
                            <form class="col-sm-12 position-relative p-4"method="post">
                                ...
                                <textarea  cols="80" rows="10" style="
                                border-radius: 10px; 
                                border-color: #00A04A;
                                margin-left: 25px;
                                ...
                                border-radius: 10px;
                                    margin-top: 20px;" type="submit" name="submit">submit</button> 
