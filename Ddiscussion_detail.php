...
if ( isset($_POST["submit"])){
    ...
    VALUES 
   ( '','$title','$content','doctor','$id',NOW())
   ";



    mysqli_query($conn, $query );
    header("location: Ddiscussion_detail.php?idthread=$id");
    }
    ...
    <div class="discuss">
        ...
        <?php $i =1; ?>
          <?php foreach($thread as $row) : ?>
            <h7 style="font-weight: normal; margin-left:120px;
                 margin-bottom: -60px;"><?= $row["date"]; ?></h7>
            <h5 style="font-weight: bold; margin-left:20px;
                 margin-top: 10px;"><?= $row["usertype"]; ?></h5>
        <h5 style="font-weight: bold; margin-left: 79px; margin-top: 10px; margin-left: 40px;"><?= $row["title"]; ?></h5>
        <h5 style="margin-bottom: 20px; margin-left: 20px; margin-left: 100px;"><?= $row["content"]; ?></h5>
        <?php endforeach; ?>
          </div>
    ...
    <div style="
        ...
        <?php foreach($threadc as $row) : ?>
            <div style="
                ...
                <h4 style="font-weight: bold; margin-left: 20px; margin-top: -10px;"><?= $row["title"]; ?></h4>
