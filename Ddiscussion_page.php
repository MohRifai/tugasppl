        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="nav nav-pills col-lg-8 col-sm-5 text-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link tebel-sedang" href="Dabout.php">About &nbsp;&nbsp;</a>
                    </li>                    
                </ul>
    ...
    <div style="
          ...
          <?php foreach($thread as $row) : ?>
            <div style="
                ...
                <h5 style="font-weight: bold;font-style: italic; margin-left:20px;
                 margin-top: -10px;"><?= $row["usertype"]; ?></h5>
                <h4 style="font-weight: bold; margin-left: 20px; margin-top: 10px;"><?= $row["title"]; ?></h4>
                <p style="margin-right: 20px;margin-left: 20px;"><?= $row["content"]; ?></p>

            </div>
            
            <a href="Ddiscussion_detail.php?idthread=<?= $row["idthread"]; ?>" class="btn btn-outline-success  shadow tebel-sedang" style="
            border-radius: 10px; 
            border: 1px solid #00A04A;
