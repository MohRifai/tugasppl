        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="nav nav-pills col-lg-8 col-sm-5 text-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link tebel-sedang" href="#">News &nbsp;&nbsp;</a>
                    </li>
                    <li class="nav-item">
                ...
                <li class="nav nav-pills">
                    ...
                    <a class="nav-link active tebel-sedang btn btn-outline-primary bg-ungu shadow" href="#">Sign In</a>
                    </div>
                </li>
            </div>
        </div>
        ...
        <div class="row mt-5 mb-5">
            ...
            <div class="col-sm-12 position-relative p-4">
                ...
                <div class="tombol mt-5 float-end" style="padding: 70px; margin-right: 100px;">
                    <a href="#" class="btn btn-outline-success  shadow tebel-sedang" style="border-radius: 50px;">Start Journey</a>
                </div>
      ...
      <div class="discuss">
        ...
        <div style="
          ...
          <?php foreach($thread as $row) : ?>
            ...
            <?php endforeach; ?>
            <a href="discussion_detail.php" class="btn btn-outline-success  shadow tebel-sedang" style="
                border-radius: 10px; 
                border: 1px solid #00A04A;
            ...
            <div class="container" style="margin-top: 50px;">
                ...
                <div class="row mt-5 mb-5">
                    ...
                    <div class="column" >
                        ...
                        <form style="float:left; margin-right: 358px" action="" method="post">
                            <li style="padding-bottom: 30px; margin-right: 358px">
                                ...
                                <input  style="
                                    ...
                                    border-radius: 10px; 
                                    border-color: #00A04A;
                                    margin-left: -25px;" type="text" name="title" id="title">
                            </li>
                            ...
                            <li style="float:left;   margin-right: 358px">
                            <button class="active btn btn-outline-primary bg-ungu shadow tebel-sedang" style=" padding-left: 20px; width: 120px; height: 60px;  border: 1px solid #4CAF50; border-radius: 10px;" type="submit" name="submit">submit</button> 
                    ...
                    <div class="column"> <form>
                        <h1 
                                    style="float:right; border-left: 90px; padding-left: 90px; ">
                                    <b>Make a<br> new thread</b>
                        </form></div>
