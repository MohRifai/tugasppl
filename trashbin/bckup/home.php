      ...
      <div class="discuss">
        ...
        <div style="
          ...
          <?php foreach($thread as $row) : ?>
                ...
                <p style="font-family: 'Roboto', sans-serif;margin-left: 20px;margin-top: 5px;">
                        <?= $row["date"]; ?>
                </p>
                <h5 style="font-weight: bold; margin-left:20px;margin-top: -10px;">
                     <?= $row["usertype"]; ?>
                </h5>

                <h6 style="font-weight: bold; margin-left:20px;margin-top: -10px;">
                    <?= $row["title"]; ?>
                </h6>
