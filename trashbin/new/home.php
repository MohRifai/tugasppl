        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                ...
                <li class="nav nav-pills">
                    ...
                    <a class="nav-link active tebel-sedang btn btn-outline-primary bg-ungu shadow" href="logout.php">Log out</a>
                    </div>
                </li>
            </div>
        </div>
    ...
    <div class="container" style="margin-top: 150px;">
        ...
        <div class="row mt-5 mb-5">
            ...
            <div class="col-sm-12 position-relative p-4">
                ...
                <h1 class="float-end" style="margin-right: 90px;"><b>To Be Happy<br> Make Other People Happy</b></h1>
